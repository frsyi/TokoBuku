        ...
        <main>
            ...
            <div id="about" class="py-12">
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <h1 class="text-3xl font-semibold text-gray-800 dark:text-gray-200">about Menu Content</h1>
                    <p class="mt-4 text-gray-600 dark:text-gray-400">Ini adalah bagian konten untuk Guest Menu.</p>
                </div>
            </div>
            <div id="feature" class="py-12">
